...
### Использовать сеть
Сеть загружается. Данные берутся с firebase real time. Реализацию сети можно посмотреть в NetworkService
